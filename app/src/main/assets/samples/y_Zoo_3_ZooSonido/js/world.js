...
var World = {
	...
	init: function initFn() {
	 ...
	 this.animalsInfo = [{
				...
				sound: new AR.Sound("assets/skunk.mp3"), //asociando el sonido del animal
                ex: -0.5,
        		ey: -0.85,
                ...
                sound: new AR.Sound("assets/squirrel.mp3"),
                ex: -0.85,
        		ey: 0,
				...
				sound: new AR.Sound("assets/donkey.mp3"),
                ex: -0.5,
        		ey: 0.85,
				...
				sound: new AR.Sound("assets/chinchilla.mp3"),
                ex: 0.5,
        		ey: -0.85,
				...
				sound: new AR.Sound( "assets/walrus.mp3"),
                ex: 0.85,
        		ey: 0,
				...
				sound: new AR.Sound( "assets/penguin.mp3"),
                ex: 0.5,
        		ey: 0.85,
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			"<div" + cssDivLeft + ">Imagenes en el zoo: Sonido</div>"+
