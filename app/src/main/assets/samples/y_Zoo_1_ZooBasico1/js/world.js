//La imágen de donkey ha sido obtenida de: http://www.dapino-colada.nl/6-animals-transparent-pngs
...
var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		...
		var imgOne = new AR.ImageResource("assets/donkey.png");
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			"<div" + cssDivLeft + ">Scan Target &#35;1 (donkey):</div>"+
